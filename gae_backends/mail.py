"""
   ...
   Took from https://github.com/django-nonrel/djangoappengine

   Which is distributed under 3-clause BSD, see https://github.com/django-nonrel/djangoappengine/blob/develop/LICENSE
"""
